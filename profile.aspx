...
<asp:Content ID="Content1" ContentPlaceHolderID="sidebar" runat="Server">
    ...
    <asp:Button ID="more_info" class="btn btn-primary btn-large menubutton" data-toggle="modal"
    ...
    <div id="modal-add" class="modal fade" style="display: none;">
        ...
        <div class="modal-body form-horizontal">
            <h1>
                ¿Estas seguro que deseas seguir a @nombre?</h1>
            <br />
            <center>
    ...
    <div id="modal-more" class="modal fade" style="display: none;">
        ...
        <div class="modal-body form-horizontal">
            <div class="control-group">
                <asp:Label ID="about_me_label_modal" runat="server" Text="Sobre mi: " class="control-label"
            ...
            <div class="control-group">
                <asp:Label ID="phone_label_modal" runat="server" Font-Bold="True" Text="Numero de telefono: "
            ...
            <div class="control-group">
                <asp:Label ID="interests_label_modal" runat="server" Font-Bold="True" Text="Intereses: "
                    class="control-label"></asp:Label>
                <div class="controls">
            ...
            <div class="control-group">
                <asp:Label ID="education_label_modal" runat="server" Font-Bold="True" Text="Eduacacion: "
                    class="control-label"></asp:Label>
                <div class="controls">
            ...
            <div class="control-group">
                <asp:Label ID="hobbies_label_modal" runat="server" Font-Bold="True" Text="Hobbies: "
                    class="control-label"></asp:Label>
                <div class="controls">
            ...
            <div class="control-group">
                <asp:Label ID="favbooks_label_modal" runat="server" Font-Bold="True" Text="Libros favoritos: "
                    class="control-label"></asp:Label>
                <div class="controls">
